...
export const docsBaseUrl = `${joinLemmyUrl}/docs/en`; // TODO find a way to redirect to the non-en folder
export const docsUrl = `${docsBaseUrl}/index.html`;
export const markdownHelpUrl = `${docsBaseUrl}/users/02-media.html#text`;
export const sortingHelpUrl = `${docsBaseUrl}/users/03-votes-and-ranking.html#votes-and-ranking`;
